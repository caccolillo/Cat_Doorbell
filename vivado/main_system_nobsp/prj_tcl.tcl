...
make_wrapper -files [get_files $origin_dir/$_xil_proj_name_.srcs/sources_1/bd/bd/bd.bd] -top
#add it to the project sources
add_files -norecurse $origin_dir/$_xil_proj_name_.gen/sources_1/bd/bd/hdl/bd_wrapper.v
