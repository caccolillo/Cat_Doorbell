...
# set project
#****************************************************************
dict set dict_prj dict_sys prj_name                  {u96v2}
dict set dict_prj dict_sys prj_part                  {xczu3eg-sbva484-1-i}
dict set dict_prj dict_sys prj_board                 {avnet.com:ultra96v2:part0:1.2}
...
# set param
#****************************************************************
dict set dict_prj dict_param  DPU_CLK_MHz            {100}
...
dict set dict_prj dict_param  DPU_DSP48_MAX_CASC_LEN {1}
