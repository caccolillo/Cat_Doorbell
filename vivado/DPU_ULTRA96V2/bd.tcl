...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./DPUCZDX8G_VAI_v3.0/prj/Vivado/hw/srcs
...
proc create_hier_cell_hier_dpu { parentCell nameHier } {
  ...
  connect_bd_net -net hier_dpu_clk_DPU_CLK [get_bd_pins DPUCZDX8G/m_axi_dpu_aclk] [get_bd_pins hier_dpu_clk/DPU_CLK] [get_bd_pins hier_dpu_ghp/CLK] [get_bd_pins hier_dpu_ghp/GHP_CLK_I]
  ...
  connect_bd_net -net hier_dpu_clk_RSTn_PERI [get_bd_pins DPUCZDX8G/m_axi_dpu_aresetn] [get_bd_pins hier_dpu_clk/RSTn_PERI] [get_bd_pins hier_dpu_ghp/GHP_RSTn] [get_bd_pins hier_dpu_ghp/RSTn_PERI]
...
MIO#SD 0#GPIO0 MIO#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#PMU GPO 0#PMU GPO 1#PMU GPO 2#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SPI 0#GPIO1 MIO#GPIO1 MIO#SPI 0#SPI 0#SPI 0#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD\
...
\
    ...
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {334} \
    ...
    CONFIG.PSU__CRL_APB__SPI1_REF_CTRL__ACT_FREQMHZ {199.980011} \
